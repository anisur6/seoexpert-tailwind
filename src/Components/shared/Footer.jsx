...
<footer className="bg-white">
    <div className="grid  grid-cols-2 gap-8 py-8 px-14 md:grid-cols-4">
        <div className=''>
        <div className="flex justify-center lg:mt-6 items-center">
              <img
                className="lg:h-14 w-auto sm:h-10"
                src="https://cdn-icons-png.flaticon.com/512/564/564419.png"
                alt="gfgfd"
              />
              <p className="ml-10 sr-only font-bold text-xl text-sky-600 md:not-sr-only ">SEOEXPERT</p>
          </div>
        </div>
        <div>
            <h2 className="mb-6 text-sm font-bold text-gray-600 uppercase">Company</h2>
        ...
        <div>
            <h2 className="mb-6 text-sm font-bold text-gray-600 uppercase">Help center</h2>
            <ul className="text-gray-500 dark:text-gray-400">
                <li className="mb-4">
        ...
        <div>
            <h2 className="mb-6 text-sm font-bold text-gray-600 uppercase">Legal</h2>
            <ul className="text-gray-500 dark:text-gray-400">
                <li className="mb-4">
                    <a href="#" className="hover:underline">Privacy Policy</a>
                </li>
                <li className="mb-4">
                    <a href="#" className="hover:underline">Condition</a>
                </li>
            </ul>
        </div>
    ...
    <div className="py-6 px-4 lg:px-14 bg-slate-50 border border-t-slate-200 md:flex md:items-center md:justify-between">
        <span className="text-sm text-gray-900 text-center lg:text-left">© 2022 <a href="https://flowbite.com/">Flowbite™</a>. All Rights Reserved.
        </span>
        <div className="flex mt-4 space-x-6 justify-center lg:justify-end md:mt-0">

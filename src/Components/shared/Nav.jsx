...
const Nav = () => {
    ...
    return (
        <>
            <Popover className="sticky top-0 drop-shadow-md z-50 bg-white">
            <div className="mx-auto max-w-7xl px-4  sm:px-6">
                ...
                <div className="hidden items-center justify-end md:flex md:flex-1 lg:w-0">
                    ...
                    <a
                    href="#"
                    className="ml-8 inline-flex items-center justify-center whitespace-nowrap rounded-md border border-transparent bg-sky-600 px-7 py-2 text-base font-medium text-white shadow-sm hover:bg-sky-800"
                    >
                    Sign up
                    </a>
                </div>
          ...
          <div className="divide-y-2 divide-gray-50 rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5">
            ...
            <div className="space-y-6 py-6 px-5">
              ...
              <div>
                <a
                  href="#"
                  className="flex w-full items-center justify-center rounded-md border border-transparent bg-sky-500 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-sky-700"
                >
                  Sign up
                </a>
